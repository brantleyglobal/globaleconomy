    ...
    <>
      <div className="flex flex-col space-y-2">
        ...
        <div
            ...
            className={`cursor-pointer max-h-[300px] justify-between shadow-md bg-primary/5 hover:shadow-xl hover:bg-secondary/30 hover:scale-[1.02] rounded-lg p-4 ${userAction === "term" ? "bg-secondary/30" : "bg-black/40"}`}
        >
        ...
        <div
            ...
            className={`cursor-pointer max-h-[300px] justify-between shadow-md bg-primary/5 hover:shadow-xl hover:bg-secondary/30 hover:scale-[1.02] rounded-lg p-4 ${userAction === "region" ? "bg-secondary/30" : "bg-black/40"}`}
        >
