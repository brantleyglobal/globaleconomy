...
import { useDeployedContractInfo } from "~~/hooks/globalDEX";
import { AllowedChainIds } from "~~/utils/globalDEX";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "~~/utils/globalDEX/contract";
