...
contract Dividend35535 is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __ERC20_init("GlobalDomnionX", "GBD35535"); 
    ...
    function update(uint256 currentQuarter, uint256 month, uint256 ts) public {
        ...
        if (localUnlock == 0) {
            ...
            if(absoluteMonth > 5) {
                adjustedTs = ts.addMonths(29); 
            } else {
                adjustedTs = ts.subMonths(29);
            }

            contractTime = adjustedTs;

            startQuarter = 2026 * 4 + 11;
            uint256 callQuarter = startQuarter + 5;
        ...
        // Past coming quarter --> advance cycle
            ...
            if (month >= localMonthKey) {
                ...
                uint256 callQuarter = currentQuarter + 5;
