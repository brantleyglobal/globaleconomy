...
contract Dividend12812 is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __ERC20_init("Dividend12812", "GBD12812"); 
    ...
    function update(uint16 currentQuarter) public {
        ...
        if (unlockQuarter == 0) {
            ...
            uint16 callQuarter = currentQuarter + committedQuarters + 12;
