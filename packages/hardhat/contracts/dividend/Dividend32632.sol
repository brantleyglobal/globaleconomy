...
contract Dividend32632 is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __ERC20_init("GlobalDomnionX", "GBD32632"); 
    ...
    function update(uint256 currentQuarter, uint256 month, uint256 ts) public {
        ...
        if (localUnlock == 0) {
            ...
            if(absoluteMonth > 5) {
                adjustedTs = ts.addMonths(26); 
            } else {
                adjustedTs = ts.subMonths(26);
            }

            contractTime = adjustedTs;

            startQuarter = 2026 * 4 + 10;
            uint256 callQuarter = startQuarter + 6;
        ...
        // Past coming quarter --> advance cycle
            ...
            if (month >= localMonthKey) {
                ...
                uint256 callQuarter = currentQuarter + 6;
