...
contract Dividend24224 is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __ERC20_init("GlobalDomnionX", "GBD24224"); 
    ...
    function update(uint256 currentQuarter, uint256 month, uint256 ts) public {
        ...
        if (localUnlock == 0) {
            ...
            if(absoluteMonth > 5) {
                adjustedTs = ts.addMonths(18); 
            } else {
                adjustedTs = ts.subMonths(18);
            }

            contractTime = adjustedTs;

            startQuarter = 2026 * 4 + 7;
            uint256 callQuarter = startQuarter + 2;
        ...
        // Past coming quarter --> advance cycle
            ...
            if (month >= localMonthKey) {
                ...
                uint256 callQuarter = currentQuarter + 2;
