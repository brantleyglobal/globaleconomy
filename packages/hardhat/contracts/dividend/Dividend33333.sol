...
contract Dividend33333 is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        __ERC20_init("GlobalDomnionX", "GBD33333"); 
    ...
    function update(uint256 currentQuarter, uint256 month, uint256 ts) public {
        ...
        if (localUnlock == 0) {
            ...
            uint256 callQuarter = startQuarter + 3;
        ...
        // Past coming quarter --> advance cycle
            ...
            if (month >= localMonthKey) {
                ...
                uint256 callQuarter = currentQuarter + 3;
